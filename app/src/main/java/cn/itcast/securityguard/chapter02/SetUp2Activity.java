...
public class SetUp2Activity extends BaseSetUpActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mBundSIMBTN = (Button) findViewById(R.id.btn_bind_sim);
        mBundSIMBTN.setOnClickListener(this);
        if (isBind()) {
            mBundSIMBTN.setEnabled(false);
        } else {
            mBundSIMBTN.setEnabled(true);
        }
    }
